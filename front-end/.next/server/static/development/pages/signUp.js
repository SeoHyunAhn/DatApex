  ...
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "onSubmitForm", e => {
      ...
      if (password !== rePassword) {
        ...
        _common_firebase__WEBPACK_IMPORTED_MODULE_2__["default"].auth().createUserWithEmailAndPassword(email, password).then(user => {
          window.location = "/";
        }).catch(error => {
          alert(error);
          this.setState({
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "onChangeInputRePassword", e => {
      this.setState({
...
module.exports = __webpack_require__(/*! /Users/youngjoon/Desktop/CS407/DatApex/front-end/pages/signUp.js */"./pages/signUp.js");
