...
function (_Component) {
  ...
  function Login() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "loginWithEmail", function () {
      var provider = new _common_firebase__WEBPACK_IMPORTED_MODULE_10__["default"].auth.EmailAuthProvider();
      _common_firebase__WEBPACK_IMPORTED_MODULE_10__["default"].auth().signInWithPopup(provider).then(function (res) {
        console.log("res.credential : ", res.credential);
        console.log("res.user : ", res.user);
        console.log("res.user.displayName : ", res.user.displayName);
...
//# sourceMappingURL=index.js.b925d32d4d96f0a6f3d3.hot-update.js.map