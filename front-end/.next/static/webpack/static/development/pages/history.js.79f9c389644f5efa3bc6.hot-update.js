        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                storage = _common_firebase__WEBPACK_IMPORTED_MODULE_9__["default"].storage().ref(); // const user = firebase.auth().currentUser.uid;
                ...
                _context.next = 5;
                return storage.child(this.state.userID).list().then(function (urls) {
...
//# sourceMappingURL=history.js.79f9c389644f5efa3bc6.hot-update.js.map