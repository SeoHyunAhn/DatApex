...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(_default, [{
    ...
    value: function handleSubmit(event) {
      ...
      console.log(this.fileInput.current.file[0].name); // if (item.id) {
      //   axios
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://localhost:8000/upload/csv/", this.fileInput); // .then(res => this.refreshList());
    }
  }, {
    key: "render",
...
//# sourceMappingURL=mlalgo.js.eff94fb13bbcb930aebc.hot-update.js.map