...
function (_React$Component) {
  ...
  function DOMWrap() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DOMWrap)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
    ...
    _this.getOverflowedSubMenuItem = function (keyPrefix, overflowedItems, renderPlaceholder) {
      ...
      return _react.default.createElement(_SubMenu.default, _extends({
