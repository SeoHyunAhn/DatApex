...
if __name__ == '__main__':
    ...
    save_path1 = os.path.join(BASE_DIR, 'backend/Algorithm_new/trainingSetT.png') 
    save_path2 = os.path.join(BASE_DIR, 'backend/Algorithm_new/testSetT.csv') 
